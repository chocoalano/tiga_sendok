...
class EditCustomersView extends GetView<EditController> {
  const EditCustomersView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Perbaharui Pelanggan'),
        centerTitle: true,
      ),
      body: SafeArea(
      ...
      floatingActionButton: Container(
        ...
        child: BtnBlock(
          text: 'Submit',
          color: primary,
          act: () => controller.updateData(controller.name.text,
